...
describe("/bundles/css", function() {
	...
	describe("GET /bundles/css?modules", function() {
		setupRequest("GET", "/bundles/css?modules");
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
	...
	describe("GET /bundles/css?modules=1a-", function() {
		setupRequest("GET", "/bundles/css?modules=1a-");
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
	...
	describe("GET /bundles/css?modules=o-test-component@1.0.19", function() {
		setupRequest("GET", "/bundles/css?modules=o-test-component@1.0.19");
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
	...
	describe("GET /bundles/css?modules=o-test-component@1.0.17%20-%201.0.19", function() {
		setupRequest(
			"GET",
	...
	describe("GET /bundles/css?modules=o-test-component@1.0.19,o-test-component@1.0.19", function() {
		setupRequest(
			"GET",
	...
	describe("GET /bundles/css?modules=o-test-component@1.0.19,o-test-component@1.0.17%20-%201.0.19", function() {
		setupRequest(
			"GET",
	...
	describe("GET /bundles/css?modules=o-test-component@1.0.17,o-test-component@1.0.19", function() {
		setupRequest(
			"GET",
	...
	describe("GET /bundles/css?modules=o-autoinit@1.3.3,o-test-component@1.0.29", function() {
		setupRequest(
			"GET",
			"/bundles/css?modules=o-autoinit@1.3.3,o-test-component@1.0.29",
		);
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
	...
	describe("GET /bundles/css?modules=o-test-component@1.0.29&minify=maybe", function() {
		setupRequest(
			"GET",
			"/bundles/css?modules=o-test-component@1.0.29&minify=maybe",
		);
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
	...
	describe("GET /bundles/css?modules=o-test-component@1.0.29&minify=on", function() {
		setupRequest(
			"GET",
			"/bundles/css?modules=o-test-component@1.0.29&minify=on",
		);
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
	...
	describe("GET /bundles/css?modules=o-test-component@1.0.29&minify=off", function() {
		setupRequest(
			"GET",
			"/bundles/css?modules=o-test-component@1.0.29&minify=off",
		);
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
