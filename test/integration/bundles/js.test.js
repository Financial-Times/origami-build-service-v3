...
describe("/bundles/js", function() {
	...
	describe("GET /bundles/js?modules", function() {
		setupRequest("GET", "/bundles/js?modules");
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
	...
	describe("GET /bundles/js?modules=1a-", function() {
		setupRequest("GET", "/bundles/js?modules=1a-");
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
	...
	describe("GET /bundles/js?modules=o-test-component@1.0.19", function() {
		setupRequest("GET", "/bundles/js?modules=o-test-component@1.0.19");
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
	...
	describe("GET /bundles/js?modules=o-test-component@1.0.17%20-%201.0.19", function() {
		setupRequest(
			"GET",
			"/bundles/js?modules=o-test-component@1.0.17%20-%201.0.19",
		);
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
	...
	describe("GET /bundles/js?modules=o-test-component@1.0.19,o-test-component@1.0.19", function() {
		setupRequest(
			"GET",
	...
	describe("GET /bundles/js?modules=o-test-component@1.0.19,o-test-component@1.0.17%20-%201.0.19", function() {
		setupRequest(
			"GET",
	...
	describe("GET /bundles/js?modules=o-test-component@1.0.17,o-test-component@1.0.19", function() {
		setupRequest(
			"GET",
	...
	describe("GET /bundles/js?modules=o-autoinit@1.3.3,o-test-component@1.0.29", function() {
		setupRequest(
			"GET",
			"/bundles/js?modules=o-autoinit@1.3.3,o-test-component@1.0.29",
		);
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
	...
	describe("GET /bundles/js?modules=o-test-component@1.0.29&export=Test_123", function() {
		setupRequest(
			"GET",
			"/bundles/js?modules=o-test-component@1.0.29&export=Test_123",
		);
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
	...
	describe("GET /bundles/js?modules=o-test-component@1.0.29&export='", function() {
		setupRequest("GET", "/bundles/js?modules=o-test-component@1.0.29&export='");
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
	...
	describe("GET /bundles/js?modules=o-test-component@1.0.29&export=%27];alert(%27ha%27)//", function() {
		setupRequest(
			"GET",
	...
	describe("GET /bundles/js?modules=o-test-component@1.0.29&minify=maybe", function() {
		setupRequest(
			"GET",
			"/bundles/js?modules=o-test-component@1.0.29&minify=maybe",
		);
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
	...
	describe("GET /bundles/js?modules=o-test-component@1.0.29&minify=on", function() {
		setupRequest(
			"GET",
			"/bundles/js?modules=o-test-component@1.0.29&minify=on",
		);
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
	...
	describe("GET /bundles/js?modules=o-test-component@1.0.29&minify=off", function() {
		setupRequest(
			"GET",
			"/bundles/js?modules=o-test-component@1.0.29&minify=off",
		);
		itRespondsWithStatus(301);
	...
	describe("GET /bundles/js?modules=o-test-component@1.0.29&autoinit=on", function() {
		setupRequest(
			"GET",
			"/bundles/js?modules=o-test-component@1.0.29&autoinit=on",
		);
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
	...
	describe("GET /bundles/js?modules=o-test-component@1.0.29&autoinit=off", function() {
		setupRequest(
			"GET",
			"/bundles/js?modules=o-test-component@1.0.29&autoinit=off",
		);
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
	...
	describe("GET /bundles/js?modules=o-test-component@1.0.29&autoinit=off&minify=off", function() {
		setupRequest(
			"GET",
	...
	describe("GET /bundles/js?modules=o-test-component@1.0.29&autoinit=off&minify=off&export=7", function() {
		setupRequest(
			"GET",
