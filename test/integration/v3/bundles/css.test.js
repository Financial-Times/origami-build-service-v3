...
test("GET /v3/bundles/css", async t => {
...
test("GET /v3/bundles/css?modules", async t => {
	return request(this.app)
...
test("GET /v3/bundles/css?modules=1a-", async t => {
	return request(this.app)
...
test("GET /v3/bundles/css?modules=o-test-component@1.0.19", async t => {
	return request(this.app)
...
test("GET /v3/bundles/css?modules=o-test-component@1.0.17%20-%201.0.19", async t => {
	return request(this.app)
...
test("GET /v3/bundles/css?modules=o-test-component@1.0.19,o-test-component@1.0.19", async t => {
	return request(this.app)
		.get(
...
test("GET /v3/bundles/css?modules=o-test-component@1.0.19,o-test-component@1.0.17%20-%201.0.19", async t => {
	return request(this.app)
		.get(
...
test("GET /v3/bundles/css?modules=o-test-component@1.0.17,o-test-component@1.0.19", async t => {
	return request(this.app)
		.get(
...
test("GET /v3/bundles/css?modules=o-autoinit@1.3.3,o-test-component@1.0.29", async t => {
	return request(this.app)
...
test("GET /v3/bundles/css?modules=o-test-component@1.0.29&minify=maybe", async t => {
	return request(this.app)
...
test("GET /v3/bundles/css?modules=o-test-component@1.0.29&minify=on&shrinkwrap=o-autoinit%401.3.3", async t => {
	return request(this.app)
...
test("GET /v3/bundles/css?modules=o-test-component@1.0.29&minify=off", async t => {
	return request(this.app)
