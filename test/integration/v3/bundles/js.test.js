...
describe.skip("/v3/bundles/js", function() {
	...
	it("GET /v3/bundles/js?modules=o-test-component@1.0.29&minify=off&export=hello", function() {
		return request(this.app)
			.get(
				"/v3/bundles/js?modules=o-test-component@1.0.29&minify=off&export=hello",
			)
			.expect(200)
			.expect(
				"cache-control",
	...
	it("GET /v3/bundles/js?modules=o-test-component@1.0.29&minify=off&export=world", function() {
		return request(this.app)
			.get(
				"/v3/bundles/js?modules=o-test-component@1.0.29&minify=off&export=world",
			)
			.expect(200)
			.expect(
				"cache-control",
