...
describe("/v2/demos", function() {
	...
	describe("GET /v2/demos?cachebust=1", function() {
		setupRequest("GET", "/v2/demos?cachebust=1");
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
	...
	describe("GET /v2/demos/o-buttons@5.8.5/B2C", function() {
		setupRequest("GET", "/v2/demos/o-buttons@5.8.5/B2C");
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
	...
	describe("GET /v2/demos/o-buttons@5.8.5/B2C?cachebust=1", function() {
		setupRequest("GET", "/v2/demos/o-buttons@5.8.5/B2C?cachebust=1");
		itRespondsWithStatus(301);
		itRespondsWithHeader(
			"location",
