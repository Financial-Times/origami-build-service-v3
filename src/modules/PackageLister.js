...
const { _RootSource } = require("./_RootSource");
const {
  lowerBound,
  ordered,
...
class PackageLister {
   ...
   * @param {(import('./SystemCache').SystemCache | null)} cache
   * @param {import('./PackageName').PackageRef} _ref
   * @param {import('./PackageName').PackageId | null} _locked
   * @param {boolean} [downgrade]
   * @param {import('./BoundSource').BoundSource} [source]
  ...
  constructor(cache, _ref, _locked, downgrade = false, source) {
    ...
    /**
     * @type {import('./PackageName').PackageRef}
     */
    this._ref = _ref;
    /**
     * @type {import('./PackageName').PackageId | null}
     */
    this._locked = _locked;
    /**
     * @type {import('./BoundSource').BoundSource | undefined}
     */
    this._source = source
      ? source
      : cache && _ref.source
   ...
   *
   * @type {Array<import('./PackageName').PackageId>}
   * @memberof PackageLister
   */
  get cachedVersions() {
   ...
   *
   * @type {Promise<Array<import('./PackageName').PackageId>>}
   * @memberof PackageLister
   */
  get _versions() {
    /**
   ...
   *
   * @type {Promise<import('./PackageName').PackageId | null>}
   * @readonly
   * @memberof PackageLister
   */
  get latest() {
   ...
   *
   * @param {VersionConstraint} constraint
   * @returns {Promise<import('./PackageName').PackageId | null>}
   ...
   *
   * @param {import('./PackageName').PackageRange} depender
   * @param {import('./PackageName').PackageRange} target
   ...
   * dependency.
   *
   * @param {Object.<string, import('./PackageName').PackageRange>} dependencies
   * @param {number} index
   * @param {boolean} upper
