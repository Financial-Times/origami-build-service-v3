...
const { PackageLister } = require("./PackageLister");
const { PackageNotFoundCause } = require("./PackageNotFoundCause");
const { PackageRange } = require("./PackageName");
const { PartialSolution } = require("./PartialSolution");
const { reformatRanges } = require("./reformatRanges");
const { SetRelation } = require("./SetRelation");
const { SolveFailure } = require("./SolveFailure");
const { SolveResult } = require("./SolveResult");
const { DOWNGRADE } = require("./SolveType");
...
class VersionSolver {
   ...
   *
   * @param {import('./SolveType').GET|import('./SolveType').DOWNGRADE} _type
   * @param {import('./SystemCache').SystemCache} _systemCache
  ...
  constructor(_type, _systemCache, _root) {
     ...
     * @type {import('./PartialSolution').PartialSolution}
     */
     ...
     * @type {import("immutable").Map<import('./PackageName').PackageRef, import('./PackageLister').PackageLister>}
     */
    this._packageListers = Map();
    /**
     * The type of version solve being performed.
     * @type {import('./SolveType').GET|import('./SolveType').DOWNGRADE}
     */
    this._type = _type;
    /**
   ...
   *
   * @param {import('./PackageName').PackageName} $package
   * @returns {import('./PackageLister').PackageLister}
   * @memberof VersionSolver
   */
