...
class PartialSolution {
  ...
  constructor() {
    ...
    this._assignments = [];
    /**
     * @type {Object.<string, import('./PackageName').PackageId>}
     */
    this._decisions = {};
    /**
    ...
    this._positive = {};
    /**
     * @type {Object.<string, import('immutable').Map<import('./PackageName').PackageRef, import('./Term').Term>>}
     */
    this._negative = {};
  }
   ...
   *
   * @type {Array<import('./PackageName').PackageRange>}
   * @memberof PartialSolution
   */
  get unsatisfied() {
   ...
   *
   * @param {import('./Term').Term} term
   * @returns {import('./SetRelation').SetRelation}
   * @memberof PartialSolution
   */
  relation(term) {
