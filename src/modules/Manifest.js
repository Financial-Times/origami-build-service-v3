...
class Manifest {
   ...
   * @param {Array<import('./PackageName').PackageRange>=} dependencies
  ...
  constructor(_name, version, dependencies, fields, sources) {
    ...
    /**
     * @type {Object.<string, import('./PackageName').PackageRange>}
     */
    this._dependencies =
      dependencies == null
        ? null
   ...
   * @static
   * @param {import('immutable').Map<any, any>} fields
   * @param {import('./SourceRegistry').SourceRegistry} _sources
   ...
   *
   * @returns {Object.<string, import('./PackageName').PackageRange>}
   * @readonly
   * @memberof Manifest
   */
  get dependencies() {
