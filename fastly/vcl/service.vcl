...
sub vcl_hash {
	...
	# Do not add the host header because it can have 1 of 3 values: origami-build-service.in.ft.com, origami-build-service-eu.herokuapp.com , origami-build-service-us.herokuapp.com
