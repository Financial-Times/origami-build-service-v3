		...
		sass.render(
			{
				...
				includePaths: [
					path.join(installationDirectory, "bower_components"),
					path.join(installationDirectory, "node_modules/@financial-times"),
					path.join(installationDirectory, "node_modules"),
				],
			},
			function(err, result) {
				if (err) {
